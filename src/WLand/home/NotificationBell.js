...
import Bell from '../../../assets/wland/icons/bell.svg';
...
const NotificationBell = () => {
  ...
  const {runAnimation, rotationStyle, scaleStyle} = useBellAnimation();
  ...
  return (
    <Animated.View style={rotationStyle}>
      <Animated.View style={[defaultStyle, scaleStyle]}>
        <Bell height={'100%'} width={'100%'} fill={theme.textSecondary} />
        {showDot && (
          <View
            style={{
              position: 'absolute',
