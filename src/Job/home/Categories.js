...
import DesignIcon from '../../../assets/job/design.svg';
import NetworkIcon from '../../../assets/job/network.svg';
import SecurityIcon from '../../../assets/job/security.svg';
import MedicalIcon from '../../../assets/job/medical.svg';
import EngineeringIcon from '../../../assets/job/engineering.svg';
      ...
      <ScrollView
        ...
        {categories.map((category, index) => (
          <Slide key={category.name} {...{index}}>
            <View style={[styles.card, cardBackgroundColor(category.name)]}>
