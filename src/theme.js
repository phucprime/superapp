...
export const shadowLineColors = [
  'rgba(71, 75, 111, .01)',
  'rgba(75, 77, 117, .1)',
  'rgba(75, 77, 117, .01)',
];

export const gradientLargeOneColors = [
  'rgba(161, 222, 255, .5)',
  'rgba(75, 77, 117, .01)',
  'rgba(75, 77, 117, .1)',
];
export const gradientSmallOneColors = [
  'rgba(255, 181, 193, .5)',
  'rgba(75, 77, 117, .01)',
  'rgba(75, 77, 117, .1)',
];
export const gradientSmallTwoColors = [
  'rgba(160, 239, 216, .5)',
  'rgba(75, 77, 117, .01)',
  'rgba(75, 77, 117, .1)',
];
export const gradientLargeTwoColors = [
  'rgba(174, 163, 255, .5)',
  'rgba(75, 77, 117, .01)',
  'rgba(75, 77, 117, .1)',
];
export const gradientLastColors = [
  'rgba(214, 218, 255, .5)',
  'rgba(75, 77, 117, .2)',
  'rgba(75, 77, 117, .1)',
];
