...
const TabIcons = {
  home: (
    <HomeIcon height={TAB_ICON_SIZE} width={TAB_ICON_SIZE} fill={theme.light} />
  ),
  more: (
    <MoreIcon height={TAB_ICON_SIZE} width={TAB_ICON_SIZE} fill={theme.light} />
  ),
  suitcase: (
    <SuitcaseIcon
  ...
  user: (
    <UserIcon height={TAB_ICON_SIZE} width={TAB_ICON_SIZE} fill={theme.light} />
  ),
};
...
const Rating = ({rating}) => {
  return (
    <View
      ...
      <StarFull height={14} width={14} fill={theme.light} />
...
const SmallBoxView = ({content: {icon, title}, colors}) => {
  return (
    <Button>
      <LinearGradient
        start={{x: 0.2, y: 0.2}}
...
const LargeBoxView = ({
  content: {icon, title, rating, reviewCount},
  colors,
}) => {
  return (
...
const BestSection = () => {
  return (
    <Button>
      <ScaleAnim
        delay={850}
        customContainerStyle={{height: 170, paddingHorizontal: 28}}>
        <LinearGradient
