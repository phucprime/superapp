...
import BackIcon from '../../../assets/job/arrow-left.svg';
import MoreIcon from '../../../assets/job/more.svg';
...
const HeaderIcon = {
  home: (
    <Image
      source={require('../../../assets/job/Niche.png')}
      style={{width: 66, resizeMode: 'contain', tintColor: theme.icon_main}}
    />
  ),
...
const Header = React.memo(props => {
  ...
  return (
    <Animated.View style={[styles.container, {opacity}]}>
      <TouchableOpacity onPress={pressed}>{Icon}</TouchableOpacity>

      {isHomePage && (
        <View style={{flexDirection: 'row', alignItems: 'center'}}>
          <TouchableOpacity style={styles.profileImgContainer}>
            <Image
              source={require('../../../assets/job/image4.png')}
