  ...
  ({item, index, onAnimationStart, onAnimationEnd, shuffleBack}) => {
    ...
    const onGestureEvent = useAnimatedGestureHandler({
      onStart: (_, ctx) => {
        ...
        cardHeight.value = withTiming(CARD_HEIGHT + DETAIL_SECTION_HEIGHT, {
      ...
      onEnd: ({velocityX, velocityY, translationX, translationY}) => {
        ...
        rotateX.value = withTiming(ROTATEX, {
          easing: Easing.inOut(Easing.ease),
        });
        cardHeight.value = withTiming(CARD_HEIGHT, {
          easing: Easing.inOut(Easing.ease),
        });
        ...
        <PanGestureHandler onGestureEvent={onGestureEvent}>
          <Animated.View style={[styles.cardDefaultStyle, cardStyle]}>
            ...
            <View
              ...
              {renderIconAndText(
                require('../../../assets/food/icons/star.png'),
                '4.6',
              )}
              <Space horizontal size={8} />
              {renderIconAndText(
                require('../../../assets/food/icons/hourglass.png'),
                '15 min',
              )}
              <Space horizontal size={8} />
              {renderIconAndText(
                require('../../../assets/food/icons/energy.png'),
                '230 cal',
              )}
            ...
            <Animated.View
              style={[styles.detailSectionDefaultStyle, detailSectionStyle]}>
              <Text
                style={{
                  fontSize: 16,
                  fontWeight: '600',
